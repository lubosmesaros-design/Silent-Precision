...
<div class="hero">
  ...
  <p class="lead">
    Nie sme názor. Sme metoda. <span class="muted">Dôkaz → rozklad → verdikt.</span>
  </p>
...
<div class="grid">
  <section class="card">
    ...
    <p class="subhead">Každý rozbor je postavený na:</p>
    <ul>
  ...
  <section class="card">
    ...
    <p class="subhead">Each analysis is based on:</p>
    <ul>
...
<div class="footerline">
  ...
  <span class="muted">No ads. No agenda. No mercy for bullshit.</span>
</div>
